...
const NAME_RULES: Array<{ pattern: string; contextWindow: number; maxTokens: number; reasoning: boolean }> = [
  { pattern: "deepseek-v4", contextWindow: 1_048_576, maxTokens: 1_048_576, reasoning: true },
  { pattern: "deepseek", contextWindow: 262_144, maxTokens: 65_536, reasoning: true },
  { pattern: "kimi-k3", contextWindow: 1_048_576, maxTokens: 131_072, reasoning: true },
  { pattern: "kimi", contextWindow: 262_144, maxTokens: 262_144, reasoning: true },
  { pattern: "glm-5.2", contextWindow: 976_000, maxTokens: 131_072, reasoning: true },
  { pattern: "glm-5", contextWindow: 202_752, maxTokens: 131_072, reasoning: true },
  ...
  { pattern: "gpt-oss", contextWindow: 131_072, maxTokens: 32_768, reasoning: true },
  { pattern: "minimax-m3", contextWindow: 512_000, maxTokens: 131_072, reasoning: true },
  { pattern: "minimax", contextWindow: 204_800, maxTokens: 131_072, reasoning: true },
  { pattern: "gemma4", contextWindow: 262_144, maxTokens: 262_144, reasoning: true },
  ...
  { pattern: "nemotron-3-nano", contextWindow: 1_048_576, maxTokens: 131_072, reasoning: true },
  { pattern: "nemotron", contextWindow: 262_144, maxTokens: 65_536, reasoning: true },
